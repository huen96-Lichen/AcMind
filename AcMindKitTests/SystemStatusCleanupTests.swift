...
final class SystemStatusCleanupTests: XCTestCase {
    ...
    func testPrimarySidebarMatchesAcWorkNavigationSections() throws {
        ...
        XCTAssertTrue(source.contains("sidebarSection(title: \"工作\""))
        XCTAssertTrue(source.contains("sidebarSection(title: \"处理\""))
        XCTAssertTrue(source.contains("sidebarSection(title: \"随身能力\""))
        XCTAssertTrue(source.contains("sidebarSection(title: \"系统\""))
        XCTAssertTrue(source.contains("AppSurfaceCard(title: title, subtitle: subtitle"))
        XCTAssertTrue(source.contains("AppSurfaceCard(title: AcWorkBrand.displayName"))
        XCTAssertTrue(source.contains("SidebarItemRow("))
        XCTAssertFalse(source.contains("sidebarSectionHeader("))
    ...
    func testPrimarySidebarSupportsCollapsedNavigationRail() throws {
        ...
        XCTAssertTrue(source.contains("compactSidebar"))
        XCTAssertTrue(source.contains("compactSection(title:"))
        XCTAssertTrue(source.contains("SidebarCompactItemRow("))
        XCTAssertTrue(source.contains("compactHeader"))
        XCTAssertTrue(source.contains("StatusBadge(text: \"主导航\""))
        ...
        XCTAssertTrue(source.contains("SidebarFooter(status: footerStatus)"))
        XCTAssertTrue(source.contains("SidebarFooter(status: footerStatus, compact: true)"))
    ...
    func testAppSurfaceTokensMatchAcWorkPhaseOneLayout() throws {
        ...
        XCTAssertTrue(source.contains("sidebarWidth: CGFloat = 216"))
