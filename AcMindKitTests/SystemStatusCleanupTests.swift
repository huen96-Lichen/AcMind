...
final class SystemStatusCleanupTests: XCTestCase {
    ...
    func testMusicServiceAndAppAwareSettingsServiceOnlyExposeLiveAPIs() throws {
        ...
        let taskQueueSource = try readSource("AcMindKit/Services/AI/Support/TaskQueue.swift")
        XCTAssertFalse(taskQueueSource.contains("public func setOnJobStatusChanged"))
        XCTAssertFalse(taskQueueSource.contains("public func enqueueBatch"))
        XCTAssertFalse(taskQueueSource.contains("public func list(status:"))
        XCTAssertFalse(taskQueueSource.contains("public func get(id:"))
        XCTAssertFalse(taskQueueSource.contains("public func cancelAll"))
        XCTAssertFalse(taskQueueSource.contains("public func updateProgress"))
        XCTAssertFalse(taskQueueSource.contains("public func updateResult"))
        XCTAssertFalse(taskQueueSource.contains("public func retry(id:"))
        XCTAssertFalse(taskQueueSource.contains("public func clearCompleted"))
        XCTAssertFalse(taskQueueSource.contains("public func stats()"))
        XCTAssertTrue(taskQueueSource.contains("private func setOnJobStatusChanged"))
        XCTAssertTrue(taskQueueSource.contains("private func enqueueBatch"))
        XCTAssertTrue(taskQueueSource.contains("private func list(status: ProcessJobStatus)"))
        XCTAssertTrue(taskQueueSource.contains("private func get(id: String)"))
        XCTAssertTrue(taskQueueSource.contains("private func cancelAll"))
        XCTAssertTrue(taskQueueSource.contains("private func updateProgress"))
        XCTAssertTrue(taskQueueSource.contains("private func updateResult"))
        XCTAssertTrue(taskQueueSource.contains("private func retry(id: String)"))
        XCTAssertTrue(taskQueueSource.contains("private func clearCompleted"))
        XCTAssertTrue(taskQueueSource.contains("private func stats() -> TaskQueueStats"))

        let agentToolRouterSource = try readSource("AcMindKit/Services/Agent/AgentToolRouter.swift")
        XCTAssertFalse(agentToolRouterSource.contains("public func enableTool"))
