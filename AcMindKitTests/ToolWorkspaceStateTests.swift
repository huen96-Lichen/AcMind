...
final class ToolWorkspaceStateTests: XCTestCase {
    ...
    func testToolsViewUsesSharedBackdropAndCardSurfaces() throws {
        ...
        XCTAssertTrue(source.contains("AppSurfaceCard(title: \"结果面板\""))
    ...
    func testAdvancedToolPanelsUseSharedBackdropAndCards() throws {
        ...
        XCTAssertTrue(source.contains("AppVisualBackdrop()"))
        XCTAssertTrue(source.contains("AppSurfaceCard(title: \"转换说明\""))
        XCTAssertTrue(source.contains("AppSurfaceCard(title: \"识别说明\""))
        XCTAssertTrue(source.contains("AppSurfaceCard(title: \"处理说明\""))
        XCTAssertTrue(source.contains("AppSurfaceCard(title: \"重命名说明\""))
    ...
    func testCoreToolPanelsUseSharedBackdropAndCards() throws {
        ...
        XCTAssertTrue(source.contains("AppVisualBackdrop()"))
        XCTAssertTrue(source.contains("AppSurfaceCard(title: \"格式说明\""))
        XCTAssertTrue(source.contains("AppSurfaceCard(title: \"编解码说明\""))
        XCTAssertTrue(source.contains("AppSurfaceCard(title: \"整理说明\""))
        XCTAssertTrue(source.contains("AppSurfaceCard(title: \"对比说明\""))
    ...
    func testCompletionToolPanelsUseSharedBackdropAndCards() throws {
        ...
        XCTAssertTrue(source.contains("AppVisualBackdrop()"))
        XCTAssertTrue(source.contains("AppSurfaceCard(title: \"批量下载说明\""))
        XCTAssertTrue(source.contains("AppSurfaceCard(title: \"视频下载说明\""))
        XCTAssertTrue(source.contains("AppSurfaceCard(title: \"接口测试说明\""))
    ...
    func testToolWorkspacePreviewUsesSharedBackdrop() throws {
        ...
        XCTAssertTrue(source.contains("AppSurfaceCard(title: \"工具台 / 工作台 预览\""))
