        ...
        [
            SecondarySidebarSection(
                ...
                items: [
                    ...
                    SecondarySidebarItem(id: "voice", title: "语音输入", icon: "mic"),
                    ...
                    SecondarySidebarItem(id: "agent", title: "Agent 生成", icon: "sparkles", isComingSoon: true)
                ]
            ),
            SecondarySidebarSection(
                id: "status",
                ...
                items: [
                    ...
                    SecondarySidebarItem(id: "refined", title: "已提炼", icon: "checkmark.circle", isComingSoon: true),
                    SecondarySidebarItem(id: "archived", title: "已归档", icon: "archivebox"),
                    SecondarySidebarItem(id: "exported", title: "已导出", icon: "square.and.arrow.up", isComingSoon: true)
                ]
            )
        ]
    }
