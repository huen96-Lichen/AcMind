...
本规范包用于定义 AcMind 从「用户收集内容」到「导出 Obsidian Markdown」的默认输出体系。
...
00_总览/
  README.md
01_规范/
  AcMind 默认输出与 Format Profile 规范 v0.2.md
  标准字段字典 v0.2.md
...
1. 把整个文件夹放入 AcMind 项目的高优先级规范目录。
2. 先让 Trae 阅读 `01_规范/AcMind 默认输出与 Format Profile 规范 v0.2.md`。
