...
|---|---|---|---|---|
| OSR-001 | High | Public documentation and committed history contain workstation-specific absolute paths such as `/Volumes/White Atlas/...` and `/Users/lichen/...`. These break GitHub links, expose local machine details, and make the repo look non-reproducible. | `README.md:150-151`; `docs/acmind-handoff-2026-06-05.md:24-28, 44-48, 58-60, 76-79`; `docs/acmind-handoff-2026-06-06.md:40-54, 71, 76-100`; `docs/Bento_Visual_Unification_Task.md:15-16, 40, 48, 55, 62, 69, 80, 88, 95, 102, 109, 116, 128-152, 163-167, 174, 186-200, 211-223, 235-236`; `docs/audit/AcWork_Workbench_Current_Layout.md:9-11, 49, 75-82`; `docs/audit/AcWork_Workbench_Component_Map.md:9-26, 37-41`; `docs/refactor/workbench-v17/WorkbenchV17_BackgroundPersistence.txt:3-4`; Git history contains the same path-heavy docs and notes. | Replace every local absolute path with a repo-relative link or a generic placeholder such as `path/to/file.swift`. Keep any local-only notes out of the public tree, or move them into a private scratch area that is not committed. |
