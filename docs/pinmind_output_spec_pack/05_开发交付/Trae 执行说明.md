# PinMind 默认输出规范 - Trae 执行说明

## 1. 任务目标

请基于本规范包，实现 PinMind 默认输出系统。
...
建立 `PinMindStandardFields` 类型，至少包含：
...
```text
PinMindStandardFields + FormatProfile
```
...
使用 `03_Format_Profile/pinmind-default.profile.json` 作为默认 Profile。
