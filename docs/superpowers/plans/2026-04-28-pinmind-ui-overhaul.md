# AcMind 全应用 UI 重构实施计划

日期：2026-04-28  
范围：基于设计稿，对 AcMind 做一次全应用、分阶段、可验证的 UI 重构

## 0. 目标

把 AcMind 从“功能可用但视觉分散”的状态，推进到“统一、克制、Apple-ish、产品级可用”的桌面应用体验。
...
- 如果需要一个英文路径的统一交接文档，可以后续再补，但本轮先以现有 `AcMind/交接文档.md` 为准
