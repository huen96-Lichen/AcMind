...
const SETTINGS_URL_MAP: Record<string, string> = {
...
const SETTINGS_PATH_HINT_MAP: Record<string, string> = {
...
export async function buildPermissionStatusSnapshot(
  ...
  return {
    screenRecording: screenCaptureStatus.state,
    accessibility: accessibilityStatus.state,
    fullDiskAccess: 'unknown' as PermissionState,
